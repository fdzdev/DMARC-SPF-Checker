...
if __name__ == "__main__":
    input_domains = input("Enter domain(s) separated by commas: ")

    # Split the input by commas to create a list of domains
    domains = [domain.strip() for domain in input_domains.split(",")]

    # Call the main function with the user input domains
    main(domains)
